...
New-AzResourceGroupDeployment -Name "SOE-Lab2-VMDeployment-Westus" -ResourceGroupName $vmimagerg -TemplateUri "https://raw.githubusercontent.com/prarolab/soephase2/master/Task2/artefacts/lab2westus/lab2vm-westus.json" -TemplateParameterObject @{"alias"=$alias}
